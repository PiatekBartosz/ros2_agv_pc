...
set(Qt5PositioningQuick_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::PositioningQuick)
    ...
    set(Qt5PositioningQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick/5.15.0"
        "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick/5.15.0/QtPositioningQuick"
    )
    ...
    foreach(_module_dep ${_Qt5PositioningQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5PositioningQuick_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::PositioningQuick)
    ...
    _populate_PositioningQuick_target_properties(RELEASE "libQt5PositioningQuick.so.5.15.0" "" FALSE)
