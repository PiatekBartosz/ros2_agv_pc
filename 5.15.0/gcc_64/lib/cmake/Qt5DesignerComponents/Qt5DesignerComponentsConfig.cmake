...
set(Qt5DesignerComponents_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::DesignerComponents)
    ...
    set(Qt5DesignerComponents_PRIVATE_INCLUDE_DIRS
        "${_qt5DesignerComponents_install_prefix}/include/QtDesignerComponents/5.15.0"
        "${_qt5DesignerComponents_install_prefix}/include/QtDesignerComponents/5.15.0/QtDesignerComponents"
    )
    ...
    foreach(_module_dep ${_Qt5DesignerComponents_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5DesignerComponents_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::DesignerComponents)
    ...
    _populate_DesignerComponents_target_properties(RELEASE "libQt5DesignerComponents.so.5.15.0" "" FALSE)
