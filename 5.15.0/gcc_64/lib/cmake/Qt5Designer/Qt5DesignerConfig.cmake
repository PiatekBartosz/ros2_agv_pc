...
set(Qt5Designer_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::Designer)
    ...
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.15.0"
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.15.0/QtDesigner"
    )
    ...
    foreach(_module_dep ${_Qt5Designer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5Designer_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::Designer)
    ...
    _populate_Designer_target_properties(RELEASE "libQt5Designer.so.5.15.0" "" FALSE)
