...
set(Qt5XcbQpa_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::XcbQpa)
    ...
    foreach(_module_dep ${_Qt5XcbQpa_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5XcbQpa_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::XcbQpa)
    ...
    _populate_XcbQpa_target_properties(RELEASE "libQt5XcbQpa.so.5.15.0" "" FALSE)
