...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros_agv_pc/src/install/agv_mcu_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/agv_mcu_package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/agv_mcu_package/environment/path.sh"
