...
#include <memory>
#include "../../../../cpp_qt_app/src/control.h"
...
QT_MOC_LITERAL(1, 8, 15), // "SettingsClicked"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11), // "HomeClicked"
QT_MOC_LITERAL(4, 37, 14), // "CamerasClicked"
QT_MOC_LITERAL(5, 52, 30), // "on_pushButton_settings_clicked"
QT_MOC_LITERAL(6, 83, 26), // "on_pushButton_home_clicked"
QT_MOC_LITERAL(7, 110, 29) // "on_pushButton_cameras_clicked"

    },
    "Control\0SettingsClicked\0\0HomeClicked\0"
    "CamerasClicked\0on_pushButton_settings_clicked\0"
    "on_pushButton_home_clicked\0"
    "on_pushButton_cameras_clicked"
};
...
void Control::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Control::SettingsClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Control::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Control::HomeClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Control::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Control::CamerasClicked)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Control::SettingsClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Control::HomeClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Control::CamerasClicked()
{
