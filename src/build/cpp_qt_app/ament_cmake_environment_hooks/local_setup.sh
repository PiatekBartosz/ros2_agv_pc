...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros_agv_pc/src/install/cpp_qt_app"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_qt_app/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_qt_app/environment/path.sh"
