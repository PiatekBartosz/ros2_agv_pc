...
bool interfaces__msg__steer__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._steer.Steer", full_classname_dest, 27) == 0);
  }
  interfaces__msg__Steer * ros_message = _ros_message;
  {  // data
...
PyObject * interfaces__msg__steer__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._steer");
