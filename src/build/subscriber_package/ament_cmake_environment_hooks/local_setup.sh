...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros_agv_pc/src/install/subscriber_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/subscriber_package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/subscriber_package/environment/path.sh"
