...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros_agv_pc/src/install/publisher_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/publisher_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/publisher_pkg/environment/path.sh"
